...
GLOG_logtostderr=1 /work/cv2/forster/software/caffe/build/tools/caffe train --solver=/u/haiwang/projects/Task3/caffenet_solver.prototxt -weights /work/cv2/haiwang/logs/caffenet_softmax_iter_20000.caffemodel
